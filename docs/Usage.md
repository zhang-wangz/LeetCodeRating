...
![image-20250715140822069](Usage.assets/image-20250715140822069.png)

对应菜单控制显示按钮如图所示

![image-20250715140907712](Usage.assets/image-20250715140907712.png)

- 当用户需要重新刷当前讨论区中的题目时，可以点击该按钮弹窗之后，点击重置按钮对显示的题目状态进行重置，重置完成后，题目可以重新刷, 需要注意的是，此时就算回答错误， 但是显示的按钮可能也会是成功(因为此前有成功回答的记录，此时会显示ac)

![image-20250715141024996](Usage.assets/image-20250715141024996.png)

- 如图，这种情况下会显示题目ac，即使重新答题时为错误，除非需要修改底层逻辑，只刷新题目最新一次答题状态，但这工作量相对来说过于庞大，暂时无法优化这一点![image-20250715141232717](Usage.assets/image-20250715141232717.png)

![image-20250715141243010](Usage.assets/image-20250715141243010.png)
